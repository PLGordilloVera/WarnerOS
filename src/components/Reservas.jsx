...
const SectionCard = ({ title, icon, children, className = "", zIndex = "z-0" }) => (
  <div className={`bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8 shadow-xl relative ${zIndex} ${className}`}>
      ...
      <div className="flex-1 overflow-y-auto custom-scroll min-h-0 relative z-10 p-4 pt-20 pb-32 flex justify-center items-start">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-2xl relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <SectionCard title="Inmueble a Reservar" icon={<House size={16}/>} zIndex="z-10">
